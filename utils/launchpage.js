...
const behaviorViewButtons = document.getElementsByClassName('behaviorViewButton');
for (let b = 0; b < behaviorViewButtons.length; b++) {
    behaviorViewButtons[b].addEventListener('click', () => {
        const res = window.ipcComms.addNewPeriodView();
    });
}